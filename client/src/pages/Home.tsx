      ...
      <section className="relative h-[700px] flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="container relative z-10 text-center text-white space-y-6">
          ...
          <motion.div 
            ...
            className="mt-10 max-w-3xl mx-auto bg-white/10 backdrop-blur-md p-4 rounded-xl border border-white/20 shadow-2xl hover:bg-white/15 transition-all duration-300"
          >
